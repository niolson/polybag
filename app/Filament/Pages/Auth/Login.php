...
class Login extends BaseLogin
{
    ...
    /**
     * Render Google SSO button below the form if enabled.
     */
    public function getSubheading(): string|HtmlString|null
    {
        ...
        return new HtmlString(
            ...
            .'<div class="relative flex items-center justify-center text-sm text-gray-500 dark:text-gray-400 mb-4">'
            .'<span class="px-2 bg-white dark:bg-gray-900">or</span>'
            .'</div>'
