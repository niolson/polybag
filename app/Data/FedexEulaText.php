...
{
    /**
     * Full text of the FedEx End User License Agreement (Distributed Product).
     * Source: FedEx_End_User_License_Agreement_Distributed_Technology.pdf
     * Required to be displayed in full (with scroll) per FedEx Integrator validation requirements.
     */
    public const TEXT = 'FedEx End User License Agreement
(3rd Party Hosted)
...
.
A COPY OF THIS EULA SHOULD BE RETAINED FOR FUTURE REFERENCE
...
“Agreement” will mean the then current version of: (1) the terms and conditions set forth in the EULA (2) all other
...
“FedEx” means (i) FedEx Corporate Services, Inc., if You are located, and access and use the Application, within
the United States of America (“USA”) when You initially execute this EULA; and, (ii) Federal Express Corporation if
You are located, or access or use the Application, outside of the USA.
...
“Materials” means text, tools, graphics, content, manuals, software (including, sample code), specifications,
...
and Privacy Notice, available here; and (5) the terms and conditions set forth on any FedEx airway bill, bill of lading
...
Subject to the terms and conditions of the Agreement, FedEx grants You a non-exclusive, royalty-free, nonassignable, non-transferable, limited, revocable license, without the right to grant sublicenses, solely to (i) access
...
FedEx Technology or the license, all whether in whole or in part by sublicense or otherwise;
Page 3 of 11
FedEx Confidential
FedEx Form No. 2002382 v 4 June 2024 Rev
...
Use the Application to provide service bureau, time-sharing, software as a service or other
...
of or in connection with Your failure to comply with the foregoing.
Page 4 of 11
FedEx Confidential
FedEx Form No. 2002382 v 4 June 2024 Rev
...
FedEx elects to provide You with information for a shipment for which You are not the shipper, recipient or thirdparty payor, the Webhooks Update may provide limited and reduced information regarding the shipment. In all
...
Application Provider. You acknowledge that use of certain Applications or services may require You to modify its
internal computer systems from time to time. You will make such modifications at Your own expense pursuant to
the instructions provided by FedEx or Application Supplier.
...
Agreement at any time and for any or no reason upon thirty (30) days written notice to FedEx. Such termination by You will
...
outside the United States, the contract of carriage is with the FedEx subsidiary, branch, or independent contractor
who originally accepts the shipment. Your use of Global Trade Manager shall not alter Your responsibility for the
preparation and accuracy of shipping documentation including import/export forms.
...
P.O. Box 108, Coraopolis, PA 15230.
Page 6 of 11
FedEx Confidential
FedEx Form No. 2002382 v 4 June 2024 Rev
...
Your account number and registration number.
Page 7 of 11
FedEx Confidential
FedEx Form No. 2002382 v 4 June 2024 Rev
...
OF MERCHANTABILITY AND FITNESS FOR A PARTICULAR PURPOSE, AND THE WARRANTIES OF NONINFRINGEMENT OR QUIET ENJOYMENT. FEDEX DOES NOT WARRANT THAT (A) FEDEX TECHNOLOGY WILL
...
ACCURACY, RELIABILITY OR OTHERWISE. FEDEX MAKES NO REPRESENTATION OR WARRANTY THAT FEDEX
Page 8 of 11
FedEx Confidential
FedEx Form No. 2002382 v 4 June 2024 Rev

TECHNOLOGY OR ANY RELATED SERVICES, INFORMATION (E.G., WEBHOOKS UPDATES) OR CONTENT IS
...
via FedEx Express Overnight Letter delivery service to: Digital Channel Enablement, FedEx Corporate Services,
Inc. 60 FedEx Parkway, Collierville, Tennessee 38017 USA. Any such notice will be effective when received by
FedEx.
...
operation, installation, maintenance, repair, overhaul, refurbishing, development, or production of military items; or for use
by a military end-user such as the national armed services (army, navy, marine, air force, or coast guard), the national
...
FedEx Corporate Services, Inc. 30 FedEx Parkway, Collierville, TN 38017.
