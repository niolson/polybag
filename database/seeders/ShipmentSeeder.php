    ...
    public function run(): void
    {
        ...
        $shipments = [
            ...
            [
                ...
                'city' => 'New York',
                'state' => 'NY',
                'zip' => '10001',  // Wrong zip (should be 10118)
                'country' => 'US',
                'phone' => '212-555-0101',
                'residential' => true,
                'value' => 50.00,
            ...
            [
                ...
                'city' => 'Cupertino',
                'state' => 'California',  // Full state name instead of abbreviation
                'zip' => '95014',
                'country' => 'US',
                'phone' => '408-555-0102',
                'residential' => false,
            ...
            [
                ...
                'city' => 'Chicago',
                'state' => 'IL',
                'zip' => '60606',  // Close but might need correction
                'country' => 'US',
                'phone' => '312-875-9447',
                'value' => 85.00,
            ...
            [
                ...
                'city' => 'San Francisco',
                'state' => 'CA',
                'zip' => '94102',  // Might match multiple buildings
                'country' => 'US',
                'phone' => '415-555-0220',
                'residential' => false,
                'value' => 175.00,
